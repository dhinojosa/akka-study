...
libraryDependencies ++= Seq (
   "com.typesafe.akka" %% "akka-actor" % "2.1.1" withSources() withJavadoc(),         // Classic Actors, Typed Actors, IO Actor etc.
   "com.typesafe.akka" %% "akka-remote" % "2.1.1" withSources() withJavadoc(),        // Remote Actors
   "com.typesafe.akka" %% "akka-slf4j" % "2.1.1" withSources() withJavadoc(),         // SLF4J Event Handler Listener
